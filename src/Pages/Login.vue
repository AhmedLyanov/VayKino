            ...
            <form @submit.prevent="onSubmit">
                <div class="container_input_form">
                    <div class="form-group">
                        <input type="text" v-model="login" class="form-control" id="login_text"
                ...
                <div class="button_log">
                    ...
                    <button type="button" class="get_button_reg" @click="this.$router.replace('/registration')">
                        Зарегистрироваться
                    </button>
                </div>
            </form>
...
const onSubmit = () => {
    ...
    if (userData) {
        if (userData.login === login.value && userData.password === password.value) {
