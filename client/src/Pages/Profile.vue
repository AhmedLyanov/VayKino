          ...
          <div class="profile-edit-form">
            <div class="profile-edit-fields">
              ...
              <select name="country" class="country_select" v-model="userProfile.country">
                ...
                <option value="Аustralia">Австралия</option>
              </select>
              <div class="profile-edit-field">
                <div class="profile-edit-input">
...
onMounted(() => {
  ...
  const savedAvatarUrl = localStorage.getItem(`avatarUrl_${currentUser}`);
  if (savedAvatarUrl) {
...
const saveProfile = () => {
  const currentUser = localStorage.getItem('currentUser');
  localStorage.setItem(`userData_${currentUser}`, JSON.stringify(userProfile.value));
  localStorage.setItem(`avatarUrl_${currentUser}`, avatarUrl.value);
