        ...
        <div class="container_input_form">
          ...
          <div class="form-group">
            <input
              ...
              placeholder="Фамилия"
            />
            <p class="error_text_pass" v-if="errors.surname">
              {{ errors.surname }}
            </p>
          </div>
          <div class="form-group">
            ...
            />
            <p class="error_text_pass" v-if="errors.login">
              {{ errors.login }}
            </p>
          </div>
          <div class="form-group">
            ...
            />
            <p class="error_text_pass" v-if="errors.password">
              {{ errors.password }}
            </p>
          </div>
          <div class="form-group">
            ...
            />
            <p class="error_text_pass" v-if="errors.passwordCheck">
          ...
          <div class="form-group">
            ...
            />
            <p class="error_text_pass" v-if="errors.email">
              {{ errors.email }}
            </p>
          </div>
          ...
          <span class="have-account"
            ...
            <router-link class="link-to" to="/login">Войти</router-link></span
          >
        </div>
      </form>
    </div>
...
const onSubmit = () => {
  ...
  localStorage.setItem(`userData_${login.value}`, JSON.stringify(userData));
  localStorage.setItem(`avatarUrl_${login.value}`, ''); 
  router.push("/login");
};
</script>
